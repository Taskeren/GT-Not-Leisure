    ...
    public void loadRecipes() {
        ...
        RecipeBuilder.builder()
            ...
            .itemInputs(
                ...
                ItemList.Robot_Arm_ZPM.get(16L),
                ItemList.Emitter_ZPM.get(16L),
                ItemList.Sensor_ZPM.get(16L),
                ItemList.Field_Generator_ZPM.get(4L),
                new Object[] { OrePrefixes.circuit.get(Materials.UV), 16L },
        ...
        TTRecipeAdder.addResearchableAssemblylineRecipe(
            ...
            new Object[] { GTModHandler.getModItem(AppliedEnergistics2.ID, "tile.BlockDrive", 64),
                GTModHandler.getModItem(AppliedEnergistics2.ID, "tile.BlockCreativeEnergyController", 1),
                GTNLItemList.QuantumComputerCore.get(4), ItemList.Quantum_Tank_IV.get(64),
                ItemList.Quantum_Chest_IV.get(64), ItemList.Field_Generator_UHV.get(4),
                new Object[] { OrePrefixes.circuit.get(Materials.UEV), 16L },
