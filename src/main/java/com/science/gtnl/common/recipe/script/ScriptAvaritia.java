    ...
    public void loadRecipes() {
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'C',
                GTModHandler.getModItem(SGCraft.ID, "sgCoreCrystal", 1, 0, missing),
                'D',
                eternityFluidPacket,
                'E',
                ...
                'I',
                GTModHandler.getModItem(GregTech.ID, "gt.metaitem.03", 1, 32177, missing),
                'J',
                universiumFluidPacket,
                'K',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 1, missing),
                'L',
                ...
                'P',
                GTModHandler.getModItem(SGCraft.ID, "sgChevronUpgrade", 1, 0, missing),
                'Q',
                ...
                'U',
                GTModHandler.getModItem(SGCraft.ID, "rfPowerUnit", 1, 0, missing),
                'V',
                NHItemList.StargateCrystalAncients.getIS(1),
                'W',
                GTModHandler.getModItem(SGCraft.ID, "stargateController", 1, 0, missing),
                'X',
                ...
                '1',
                GTModHandler.getModItem(SGCraft.ID, "sgIrisUpgrade", 1, 0, missing),
                '2',
                ...
                '8',
                GTModHandler.getModItem(AppliedEnergistics2.ID, "item.ItemExtremeStorageCell.Universe", 1, 0, missing),
                '9',
                GTModHandler.getModItem(AppliedEnergistics2.ID, "tile.BlockCreativeEnergyCell", 1, 0, missing),
                'a',
                NHItemList.ChevronPolychrome.getIS(1),
                'b',
                GTModHandler.getModItem(EnderIO.ID, "blockCapBank", 1, 0, missing),
                'c',
                GTModHandler.getModItem(AE2FluidCraft.ID, "fluid_storage.Universe", 1, 0, missing),
                'd',
                GTModHandler.getModItem(SGCraft.ID, "sgControllerCrystal", 1, 0, missing),
                'e',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                "pqrstuvwx",
                'A',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.spaceship", 1, 0, missing),
                'B',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.spaceshipTier2", 1, 0, missing),
                'C',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.itemTier3Rocket", 1, 0, missing),
                'D',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier4Rocket", 1, 0, missing),
                'E',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars4", 1, 14, missing),
                'F',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier5Rocket", 1, 0, missing),
                'G',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier6Rocket", 1, 0, missing),
                'H',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier7Rocket", 1, 0, missing),
                'I',
                GTModHandler.getModItem(GalaxySpace.ID, "item.Tier8Rocket", 1, 0, missing),
                'J',
                GregtechItemList.Large_Steam_Turbine.get(1),
                'K',
                GTModHandler.getModItem(Avaritia.ID, "Cosmic_Meatballs", 1, 0, missing),
                'L',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 8, missing),
                'M',
                ...
                'P',
                GTModHandler.getModItem(Avaritia.ID, "Ultimate_Stew", 1, 0, missing),
                'Q',
                ...
                '2',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars4", 1, 15, missing),
                '3',
                ...
                '8',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars5", 1, 2, missing),
                '9',
                ...
                'j',
                GTModHandler.getModItem(Avaritia.ID, "Akashic_Record", 1, 0, missing),
                'k',
                ...
                'n',
                GTModHandler.getModItem(Avaritia.ID, "Orb_Armok", 1, 0, missing),
                'o',
                ...
                't',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EMTSolars5", 1, 1, missing),
                'u',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                ":[]^_=?~!",
                'A',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 4, missing),
                'B',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 5, missing),
                'C',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 8, missing),
                'D',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 0, missing),
                'E',
                ...
                'H',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 18, missing),
                'I',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 11, missing),
                'J',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 2, missing),
                'K',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 1, missing),
                'L',
                ...
                'O',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 1, missing),
                'P',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 4, missing),
                'Q',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 16, missing),
                'R',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 1, missing),
                'S',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 20, missing),
                'T',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 7, missing),
                'U',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.projectRed.singularity", 1, 0, missing),
                'V',
                ...
                '0',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 15, missing),
                '1',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 2, missing),
                '2',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 0, missing),
                '3',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 3, missing),
                '4',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 0, missing),
                '5',
                GTModHandler
                ...
                'c',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 4, missing),
                'd',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 8, missing),
                'e',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 23, missing),
                'f',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 5, missing),
                'g',
                ...
                'k',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 14, missing),
                'l',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 19, missing),
                'm',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 6, missing),
                'n',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 10, missing),
                'o',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 6, missing),
                'p',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 3, missing),
                'q',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 24, missing),
                'r',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 25, missing),
                's',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 15, missing),
                't',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1, 1, missing),
                'u',
                ...
                'x',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 6, missing),
                'y',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 10, missing),
                'z',
                ...
                '>',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 4, missing),
                ';',
                GTModHandler.getModItem(EternalSingularity.ID, "combined_singularity", 1, 1, missing),
                ':',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 5, missing),
                '[',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 9, missing),
                ']',
                GTModHandler.getModItem(Avaritia.ID, "Singularity", 1, 3, missing),
                '^',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 27, missing),
                '_',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 28, missing),
                '=',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 29, missing),
                '?',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.vanilla.singularity", 1, 0, missing),
                '~',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.enderIO.singularity", 1, 3, missing),
                '!',
                GTModHandler.getModItem(UniversalSingularities.ID, "universal.general.singularity", 1, 13, missing));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'D',
                GTModHandler.getModItem(DraconicEvolution.ID, "dezilsMarshmallow", 1, 0, missing),
                'E',
                GTModHandler.getModItem(GalacticraftAmunRa.ID, "item.schematic", 1, 0, missing),
                'F',
                GTModHandler.getModItem(DraconicEvolution.ID, "teleporterMKII", 1, 0, missing),
                'G',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.schematic", 1, 1, missing),
                'H',
                GTModHandler.getModItem(DraconicEvolution.ID, "chaoticCore", 1, 0, missing),
                'I',
                kubatech.api.enums.ItemList.DEFCWyvernSchematic.get(1),
                'J',
                GTModHandler.getModItem(StevesCarts2.ID, "CartModule", 1, 61, missing),
                'K',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 91, missing),
                'L',
                GTModHandler.getModItem(ThaumicEnergistics.ID, "storage.essentia", 1, 4, missing),
                'M',
                GTModHandler.getModItem(SGCraft.ID, "stargateBase", 1, 0, missing),
                'N',
                GTModHandler.getModItem(SGCraft.ID, "stargateRing", 1, 0, missing),
                ...
                'Q',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 93, missing),
                'R',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier8", 1, 0, missing),
                'S',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 4, missing),
                'T',
                ItemList.EnergisedTesseract.get(1),
                'U',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 5, missing),
                'V',
                GTModHandler.getModItem(GalacticraftMars.ID, "item.schematic", 1, 0, missing),
                'W',
                GTModHandler.getModItem(GalacticraftCore.ID, "item.infiniteOxygen", 1, 0, missing),
                'X',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 90, missing),
                'Y',
                GTModHandler.getModItem(Thaumcraft.ID, "ItemEldritchObject", 1, 3, missing),
                'Z',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 2, missing),
                '0',
                GTModHandler.getModItem(ExtraUtilities.ID, "dark_portal", 1, 0, missing),
                '1',
                GTModHandler.getModItem(ElectroMagicTools.ID, "EssentiaGenerators", 1, 3, missing),
                '2',
                GTModHandler.getModItem(Botania.ID, "pool", 1, 1, missing),
                '3',
                GTModHandler.getModItem(ProjectRedFabrication.ID, "projectred.fabrication.icchip", 1, 1, missing),
                '4',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 103, missing),
                '5',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier7", 1, 0, missing),
                '6',
                ...
                '9',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier4", 1, 0, missing),
                'a',
                GTModHandler.getModItem(AE2WCT.ID, "infinityBoosterCard", 1, 0, missing),
                'b',
                GTModHandler.getModItem(OpenComputers.ID, "item", 1, 69, missing),
                'c',
                ...
                'g',
                GTModHandler.getModItem(Computronics.ID, "computronics.ocSpecialParts", 1, 0, missing),
                'h',
                kubatech.api.enums.ItemList.DEFCDraconicSchematic.get(1),
                'i',
                GTModHandler.getModItem(Avaritia.ID, "Infinity_Pickaxe", 1, 0, missing),
                'j',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier6", 1, 0, missing),
                'k',
                GTModHandler.getModItem(Botania.ID, "terraPick", 1, 0, missing),
                'l',
                GTModHandler.getModItem(GalaxySpace.ID, "item.SchematicTier5", 1, 0, missing),
                'm',
                GTModHandler.getModItem(ThaumicTinkerer.ID, "ichorPickGem", 1, 0, missing),
                'n',
                kubatech.api.enums.ItemList.DEFCAwakenedSchematic.get(1),
                'o',
                GTModHandler.getModItem(Witchery.ID, "infinityegg", 1, 0, missing),
                'p',
                GTModHandler.getModItem(DraconicEvolution.ID, "reactorCore", 1, 0, missing));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'B',
                GTModHandler.getModItem(IndustrialCraft2.ID, "itemPartCircuit", 1, 0, missing),
                'C',
                ...
                'F',
                GTModHandler.getModItem(IndustrialCraft2.ID, "itemPartCircuitAdv", 1, 0, missing),
                'G',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'M',
                new ItemStack(GregTechAPI.sBlockMachines, 1, LESU.ID),
                'N',
                ...
                'Q',
                new ItemStack(GregTechAPI.sBlockMachines, 1, Windmill.ID),
                'R',
                ...
                '7',
                new ItemStack(GregTechAPI.sBlockMachines, 1, BioVat.ID),
                '8',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'C',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 1, missing),
                'D',
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'F',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 5, missing),
                'G',
                GTModHandler.getModItem(Avaritia.ID, "Endest_Pearl", 1, 0, missing));
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                "BB--B----",
                'A',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 0, missing),
                'B',
                GTModHandler.getModItem(Avaritia.ID, "Crystal_Matrix", 1, 0, missing),
                'C',
                GTModHandler.getModItem(Avaritia.ID, "Resource", 1, 1, missing),
        ...
        ExtremeCraftingManager.getInstance()
            .addExtremeShapedOreRecipe(
                ...
                'F',
                GTModHandler.getModItem(ExtraUtilities.ID, "cobblestone_compressed", 1, 6),
                'G',
